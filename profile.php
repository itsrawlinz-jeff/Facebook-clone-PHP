...
function post_date_latest_sort($post1, $post2) {
    ...
    return $post1->get_property('post_date') < $post2->get_property('post_date') ?  : (($post1->get_property('post_date') > $post2->get_property('post_date')) ? -1 : 1);
...
<head>
    ...
    <title>Fortunebook - <?php echo $fetched_user->getPropertyValue("username"); ?></title>
                ...
                <div id="profile-picture-container">
                    ...
                    <div class="viewer">
                        ...
                        <div class="profile-picture-preview-container">
                            <img src="./public/assets/images/logos/default.jpg" class="profile-picture-preview" alt="User's name Profile picture">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="posts-container">
                    <?php if(count($posts) == 0) { ?>
                        <div id="empty-posts-message">
                            ...
                            <p>click <a href="http://localhost/CHAT/search.php" class="link" style="color: rgb(66, 219, 66)">here</a> to go to the search page</p>
                        </div>
                    <?php } else { 
